...
namespace Skender.Stock.Indicators
{
    public static partial class Indicator
    {
            ...
            where TQuote : IQuote
        {
            ...
            // calculate
            return CalcEma(bdList, lookbackPeriod, minimalPeriods);
        }


        private static IEnumerable<EmaResult> CalcEma(
            List<BasicData> bdList, int lookbackPeriod, int? minimalPeriods = null)
        {
            // check parameter arguments
            ValidateEma(bdList, lookbackPeriod, minimalPeriods);
            ...
            int? minimalPeriods)
        {
            ...
            int minHistory = minimalPeriods ?? Math.Max(2 * lookbackPeriod, lookbackPeriod + 100);
